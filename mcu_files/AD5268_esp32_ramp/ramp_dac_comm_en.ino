...
#define SER_CLK_WRITE_PIN 9  // A11 GPIO1
// P23 on board
...
void setup() {
  ...
  digitalWrite(SER_CLK_WRITE_EN_PIN, HIGH);
  pinMode(SER_MON_EN_PIN, OUTPUT);
  digitalWrite(SER_MON_EN_PIN, HIGH);
   // Enable SERIAL WRITE pins
  ...
  digitalWrite(LS_CH1_EN_PIN, LOW);
  ...
  ramp_dac_voltage(DAC_CH_VDACREF, 1.0, RAMP_TIME_MS, 15, RAMP_STEPS);
